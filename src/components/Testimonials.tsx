     ...
     <section id="testimonials" className="bg-[#0a0908] py-40 px-4 md:px-8">
      <div className="text-white text-center">
        <h4 className="text-white text-4xl lg:text-5xl font-[Caveat] ">
          <span>
            <span className="text-[#103e44]">W</span>hat{' '}
            <span className="text-[#103e44]">O</span>ther{' '}
            <span className="text-[#103e44]">P</span>eople{' '}
            <span className="text-[#103e44]">S</span>ay
          </span>
        </h4>
        ...
        <div className="mt-24 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              >
                ...
                <p className="my-4 text-[#103e44]">{person.role}</p>
