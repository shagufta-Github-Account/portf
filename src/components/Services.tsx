      ...
      <section id="services" className="py-40 px-2 md:px-8 bg-[#1a1a1a]">
        <div className="text-center">
          <h4 className="text-white text-4xl lg:text-5xl font-[Caveat]">
            <span className="">
              <span className="text-[#103e44] capitalize">w</span>hat{" "}
              <span className="text-[#103e44] capitalize">I</span>{" "}
              <span className="text-[#103e44] capitalize">d</span>o{" "}
              <span className="text-[#103e44] capitalize">f</span>or{" "}
              <span className="text-[#103e44] capitalize">c</span>lients
            </span>
          </h4>
